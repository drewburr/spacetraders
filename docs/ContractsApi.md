# spacetraders-client.ContractsApi
...
with spacetraders-client.ApiClient(configuration) as api_client:
    ...
    api_instance = spacetraders-client.ContractsApi(api_client)
...
with spacetraders-client.ApiClient(configuration) as api_client:
    ...
    deliver_contract_request = spacetraders-client.DeliverContractRequest() # DeliverContractRequest |  (optional)
