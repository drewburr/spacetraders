    ...
    def make_instance(self, include_optional) -> GetMarket200Response:
        ...
        if include_optional:
            return GetMarket200Response(
                data = client.models.market.Market(
                    symbol = '', 
                    exports = [
                        client.models.trade_good.TradeGood(
                    ...
                    transactions = [
                        client.models.market_transaction.MarketTransaction(
                            waypoint_symbol = '0', 
                            ship_symbol = '', 
                            trade_symbol = '', 
                            type = 'PURCHASE', 
                    ...
                    trade_goods = [
                        client.models.market_trade_good.MarketTradeGood(
                            symbol = , 
                            type = 'EXPORT', 
                            trade_volume = 1, 
                            supply = 'SCARCE', 
