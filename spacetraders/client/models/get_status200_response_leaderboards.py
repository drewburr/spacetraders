...
class GetStatus200ResponseLeaderboards(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "mostCredits": [GetStatus200ResponseLeaderboardsMostCreditsInner.from_dict(_item) for _item in obj.get("mostCredits")] if obj.get("mostCredits") is not None else None,
            "mostSubmittedCharts": [GetStatus200ResponseLeaderboardsMostSubmittedChartsInner.from_dict(_item) for _item in obj.get("mostSubmittedCharts")] if obj.get("mostSubmittedCharts") is not None else None
        })
        return _obj
