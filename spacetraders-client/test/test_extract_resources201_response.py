    ...
    def make_instance(self, include_optional) -> ExtractResources201Response:
        ...
        if include_optional:
            return ExtractResources201Response(
                data = client.models.extract_resources_201_response_data.extract_resources_201_response_data(
                    cooldown = client.models.cooldown.Cooldown(
                        ship_symbol = '0',
                        total_seconds = 0,
                        remaining_seconds = 0,
                        expiration = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                    extraction = client.models.extraction.Extraction(
                        ship_symbol = '0',
                        yield = client.models.extraction_yield.ExtractionYield(
