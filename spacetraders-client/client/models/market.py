        ...
        _obj = cls.model_validate(
            {
                ...
                "exports": [TradeGood.from_dict(_item) for _item in obj.get("exports")]
                if obj.get("exports") is not None
                else None,
                "imports": [TradeGood.from_dict(_item) for _item in obj.get("imports")]
                if obj.get("imports") is not None
                else None,
                "exchange": [
                    TradeGood.from_dict(_item) for _item in obj.get("exchange")
                ]
