        ...
        _obj = cls.model_validate(
            {
                ...
                "registration": ShipRegistration.from_dict(obj.get("registration"))
                if obj.get("registration") is not None
                else None,
                "nav": ShipNav.from_dict(obj.get("nav"))
                if obj.get("nav") is not None
                else None,
                "frame": ScannedShipFrame.from_dict(obj.get("frame"))
                if obj.get("frame") is not None
                else None,
                "reactor": ScannedShipReactor.from_dict(obj.get("reactor"))
                if obj.get("reactor") is not None
                else None,
                "engine": ScannedShipEngine.from_dict(obj.get("engine"))
                if obj.get("engine") is not None
                else None,
                "mounts": [
                    ScannedShipMountsInner.from_dict(_item)
                    for _item in obj.get("mounts")
                ]
