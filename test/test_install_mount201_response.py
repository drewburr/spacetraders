    ...
    def make_instance(self, include_optional) -> InstallMount201Response:
        ...
        if include_optional:
            return InstallMount201Response(
                data = spacetraders-client.models.install_mount_201_response_data.Install_Mount_201_Response_data(
                    ...
                    transaction = spacetraders-client.models.ship_modification_transaction.ShipModificationTransaction(
                        waypoint_symbol = '', 
                        ship_symbol = '', 
                        trade_symbol = '', 
                        total_price = 0, 
