    ...
    def make_instance(self, include_optional) -> CreateShipSystemScan201Response:
        ...
        if include_optional:
            return CreateShipSystemScan201Response(
                data = spacetraders-client.models.create_ship_system_scan_201_response_data.create_ship_system_scan_201_response_data(
                    ...
                    systems = [
                        spacetraders-client.models.scanned_system.ScannedSystem(
                            symbol = '0', 
                            sector_symbol = '0', 
                            type = 'NEUTRON_STAR', 
                            x = 56, 
