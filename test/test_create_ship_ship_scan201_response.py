    ...
    def make_instance(self, include_optional) -> CreateShipShipScan201Response:
        ...
        if include_optional:
            return CreateShipShipScan201Response(
                data = spacetraders-client.models.create_ship_ship_scan_201_response_data.create_ship_ship_scan_201_response_data(
                    ...
                    ships = [
                        spacetraders-client.models.scanned_ship.ScannedShip(
                            symbol = '', 
