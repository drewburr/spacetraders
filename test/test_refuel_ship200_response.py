    ...
    def make_instance(self, include_optional) -> RefuelShip200Response:
        ...
        if include_optional:
            return RefuelShip200Response(
                data = spacetraders-client.models.refuel_ship_200_response_data.refuel_ship_200_response_data(
                    ...
                    transaction = spacetraders-client.models.market_transaction.MarketTransaction(
                        waypoint_symbol = '0', 
                        ship_symbol = '', 
                        trade_symbol = '', 
                        type = 'PURCHASE', 
