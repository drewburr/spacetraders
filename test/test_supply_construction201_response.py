    ...
    def make_instance(self, include_optional) -> SupplyConstruction201Response:
        ...
        if include_optional:
            return SupplyConstruction201Response(
                data = spacetraders-client.models.supply_construction_201_response_data.supply_construction_201_response_data(
                    construction = spacetraders-client.models.construction.Construction(
                        symbol = '', 
                        materials = [
                            spacetraders-client.models.construction_material.ConstructionMaterial(
